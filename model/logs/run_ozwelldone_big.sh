...
RES=logs/FINAL_RESULTS_OZWBIG.txt
ACC="$P/eleven_accent_pos_done_big.npy"
ONNX="checkpoints/scratch-onnx/ozwelldone_elacbig.onnx"
...
echo "" | tee -a "$RES"; echo "=== OZWBIG DONE $(date) — adopt only if cross-vendor UP, originals HELD, FP HELD ===" | tee -a "$RES"
