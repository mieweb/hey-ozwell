...
- Problem: enrolled CLEAR, tested in background noise → WHO (speaker) dipped toward/below the 0.4 gate →
  recall dropped to about 8/10 (hey-ozwell) and 7/10 (ozwell-i'm-done) (Jonathan's recollection, not a
  fresh counted run).
